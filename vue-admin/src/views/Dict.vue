<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%" stripe
      ...
      <el-table-column prop="value" label="字典内容">
        <template slot-scope="scope">
          <i :class="scope.row.value" style="font-size:18px "></i> {{scope.row.value}}
        </template>
      </el-table-column>
      <el-table-column prop="type" label="字典类型" class-name="fs-24" align="center" label-class-name="fs-12">
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="dialogFormVisible" width="25%">
      <el-form :model="form" label-width="70px" size="small">
        ...
        <el-form-item label="字典内容">
          <el-input v-model="form.value" autocomplete="off" clearable></el-input>
        </el-form-item>
        <el-form-item label="字典类型">
          <el-input v-model="form.type" autocomplete="off" clearable></el-input>
        </el-form-item>
      </el-form>
